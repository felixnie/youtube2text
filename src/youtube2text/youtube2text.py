...
class Youtube2Text:
    ...
    def url2text(
        self, urlpath, outfile=None, audioformat="flac", audiosamplingrate=16000
    ):
        """
        ...
        self.url2audio(
            urlpath, audiofile=audiofile, audiosamplingrate=audiosamplingrate
        )
    ...
    def audio2text(self, audiofile, textfile=None):
        ...
        df = self._get_large_audio_transcription(
            audiofile, audiochunkfolder=audiochunkfolder, audiochunkpath=audiochunkpath
        )
    ...
    def _get_large_audio_transcription(
        self, audiofullpath, audiochunkfolder, audiochunkpath=None
    ):
        """
